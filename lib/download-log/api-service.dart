...
// Helper function to get month name from month number
  ...
  // Method to save the file to the Downloads directory
  Future<void> _saveFileToDownloads(List<int> bytes, String fileName) async {
    try {
      String pathToFile; // Declare the variable to hold the file path
      ...
      if (Platform.isAndroid) {
        ...
        // For iOS, use the application's Documents directory
